...
```
🦷 Dento Khata কী?
বাংলাদেশের ডেন্টাল চেম্বারের জন্য তৈরি একটি সম্পূর্ণ ম্যানেজমেন্ট সফটওয়্যার। খাতা-কলমের ঝামেলা ছাড়াই আপনার পুরো চেম্বার এক জায়গায় ডিজিটালভাবে চালান — মোবাইল, ট্যাব বা ল্যাপটপ, যেকোনো ডিভাইসে।

✅ যা যা পাবেন:
📇 রোগীর সম্পূর্ণ রেকর্ড — ছবি, হিস্ট্রি, নোট সব একসাথে
📅 অ্যাপয়েন্টমেন্ট ক্যালেন্ডার — কে এলো, কে এলো না রঙে বোঝা যায়
🦷 ডেন্টাল চার্ট — দাঁতের অবস্থা ক্লিক করে মার্ক করুন
🖨️ বাংলা প্রেসক্রিপশন — ৮,৯০০+ ওষুধের তালিকা, এক ক্লিকে প্রিন্ট
💵 বিলিং ও বাকির হিসাব — কে কত দিল, কত বাকি, নিখুঁত হিসাব
📊 দৈনিক ও মাসিক আয়ের রিপোর্ট
💾 প্রতিদিন অটো ব্যাকআপ — ডেটা কখনো হারাবে না
👥 স্টাফদের আলাদা লগইন ও সীমিত অ্যাক্সেস

💰 প্যাকেজ:
• ১ মাস — ৳১,৯৯০
• ৬ মাস — ৳১০,৯৯০ (৳৯৫০ সাশ্রয়)
• ১২ মাস — ৳১৯,৯৯০ (২ মাস ফ্রি-র সমান)

🎯 সেটআপ মাত্র ১০ মিনিটে · কোনো ট্রেনিং লাগে না · ২৪/৭ সাপোর্ট · নিয়মিত নতুন ফিচার

🌐 ওয়েবসাইট: dento.devcenter.dev
📲 যেকোনো প্রশ্নে সরাসরি এই নম্বরে WhatsApp করুন — আমরা সাহায্য করতে প্রস্তুত।


ডেমো দেখতে চাইলে এই ভিডিওটি দেখতে পারেন। 
https://youtu.be/jFBJq74gU9I
